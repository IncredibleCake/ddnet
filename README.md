This is a fork of the official DDNet project. Its prupose is to change the way maps work and what the server can send to the client. See the full description in ZMOD.md
Beyond is the previous README.md
